...
# A. Get All Students
curl -X GET "https://studious-fortnight-4j5q79q56p55fvwr-8000.app.github.dev/api/students"

# B. Get One Student
curl -X GET "http://localhost:8000/api/students/1"

# C. Create Student
curl -X POST "https://studious-fortnight-4j5q79q56p55fvwr-8000.app.github.dev/api/students" \
